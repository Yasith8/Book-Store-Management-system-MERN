  ...
  return (
    <div className='w-fit'>
      ...
      {loading?(<Sprinner/>):(
        ...
        <button type="submit" className='bg-purple-600 border-2 border-purple-600 w-[10rem] h-[2.5rem] p-2 text-white font-semibold rounded-full' onClick={submitHandler}>Add Book</button>
        </div>
      </form>
        )}
    </div>
